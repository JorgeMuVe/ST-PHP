<?php
    ...
    $delivery->idDistrito = ""+$data->idDistrito;
    $delivery->idProvincia = ""+$data->idProvincia;
    $delivery->idDepartamento = ""+$data->idDepartamento;
    
    // AGREGAR COMENTARIO
    $result = $delivery->listarDeliveryEnCobertura();
