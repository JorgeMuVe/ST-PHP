<?php
    class Direccion {
        ...
        public function paginadoDirecciones(){
            ...
            if($stmtCantidad){
                $queryBusqueda = 'CALL paginadoDirecciones(:codigoUsuario,:inicio,:cantidad)';
                $stmtBusqueda = $this->conn->prepare($queryBusqueda);
                
                $this->codigoUsuario = (int)htmlspecialchars(strip_tags($this->codigoUsuario));
                $this->inicio = (int)htmlspecialchars(strip_tags($this->inicio));
                $this->cantidad = (int)htmlspecialchars(strip_tags($this->cantidad));
